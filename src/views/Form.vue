<template>
  <div class="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-6">
    <div class="max-w-md w-full p-6 border rounded-lg shadow-md bg-white">
      <h2 class="text-2xl font-semibold mb-4 text-gray-800 text-center">Provide your property details</h2>
    ...
    <div v-if="submittedData.length" class="max-w-4xl w-full mt-8 p-6 border rounded-lg shadow-md bg-white">
      <h2 class="text-xl font-semibold mb-4 text-gray-800 text-center">Submitted Data</h2>
